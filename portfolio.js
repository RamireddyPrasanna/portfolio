...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Prasanna.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">R.Prasanna.</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> Prasanna
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="resume.doc" download>Download CV</a>
        </div>
      ...
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm Ramireddy Prasanna pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp;Computer Science and Engineering.</span> I am passionate about knowing new things in the world and I am also passionate about coding. Self-motivated, highly passionate, and hardworking fresh mind looking for an opportunity to work in a challenging organization to utilize and enhance my skills and knowledge to work for the growth of the organization.</p>
        <ul>
          <li>From - Koilakuntla, India</li>
          <li>Lives in - Mukkamalla, India</li>
          <li>Age - 20</li>
          <li>Gender - Female</li>
        </ul>
      </section>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Z.P.H.SCHOOL, Akumalla,Koilakuntla</p>
              <p>I got 9.2 CGPA in my School Education.</p>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 1-47,<br /> Mukkamalla,<br /> Sanjamal(M),<br /> Nandyal(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="mailto:ramireddyprasanna45@gmail.com">ramireddyprasanna@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 7780730913">7780730913</a></p>
            </div>
          </div>
